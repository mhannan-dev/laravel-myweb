                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.service.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="small mb-1" for="icon">Icon <a href="https://borlangerk.se/wp-content/themes/tunhuken/fonts/flaticon/font/flaticon.html" target="_blank">Help</a></label>
                                    <input class="form-control py-4" id="icon" name="icon" type="text" placeholder='Icon class <span class="flaticon-pen"></span> ' required />
                                </div>
