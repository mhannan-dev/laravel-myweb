                ...
                <div class="col-lg-12">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">Update Service Information</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.service.update', $data_list->id) }}" method="POST">
                                @csrf

                                <div class="form-group">
                                    <label class="small mb-1" for="title">Icon</label>
                                    <input class="form-control py-4" id="icon" name="icon" type="text" value="{{ $data_list->icon }}"/>
                                </div>
                                <div class="form-group">
